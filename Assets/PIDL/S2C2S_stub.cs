...
public BeforeRmiInvocationDelegate BeforeRmiInvocation = delegate(Nettention.Proud.BeforeRmiSummary summary) {};
		...
		public delegate bool JoinInGameDelegate(Nettention.Proud.HostID remote,Nettention.Proud.RmiContext rmiContext, int character_num, int Room_id);  
		public JoinInGameDelegate JoinInGame = delegate(Nettention.Proud.HostID remote,Nettention.Proud.RmiContext rmiContext, int character_num, int Room_id)
		{ 
			return false;
		};
		...
		public delegate bool CountStartDelegate(Nettention.Proud.HostID remote,Nettention.Proud.RmiContext rmiContext);  
		public CountStartDelegate CountStart = delegate(Nettention.Proud.HostID remote,Nettention.Proud.RmiContext rmiContext)
		{ 
			return false;
		};
		...
		public delegate bool Player_SetReadyDelegate(Nettention.Proud.HostID remote,Nettention.Proud.RmiContext rmiContext);  
		public Player_SetReadyDelegate Player_SetReady = delegate(Nettention.Proud.HostID remote,Nettention.Proud.RmiContext rmiContext)
		{ 
			return false;
		};
		public delegate bool Player_SetResponseDelegate(Nettention.Proud.HostID remote,Nettention.Proud.RmiContext rmiContext, int team_num, bool value);  
		public Player_SetResponseDelegate Player_SetResponse = delegate(Nettention.Proud.HostID remote,Nettention.Proud.RmiContext rmiContext, int team_num, bool value)
		{ 
			return false;
		};
		...
		public delegate bool Player_KillDelegate(Nettention.Proud.HostID remote,Nettention.Proud.RmiContext rmiContext, int m_team_num);  
		public Player_KillDelegate Player_Kill = delegate(Nettention.Proud.HostID remote,Nettention.Proud.RmiContext rmiContext, int m_team_num)
		{ 
			return false;
		};
		public delegate bool Get_seleteDelegate(Nettention.Proud.HostID remote,Nettention.Proud.RmiContext rmiContext);  
		public Get_seleteDelegate Get_selete = delegate(Nettention.Proud.HostID remote,Nettention.Proud.RmiContext rmiContext)
		{ 
			return false;
		};
		public delegate bool Set_seleteDelegate(Nettention.Proud.HostID remote,Nettention.Proud.RmiContext rmiContext, int result, int Room_id, int Min, int Sec);  
		public Set_seleteDelegate Set_selete = delegate(Nettention.Proud.HostID remote,Nettention.Proud.RmiContext rmiContext, int result, int Room_id, int Min, int Sec)
		{ 
			return false;
		};
		public delegate bool Get_ENDDelegate(Nettention.Proud.HostID remote,Nettention.Proud.RmiContext rmiContext);  
		public Get_ENDDelegate Get_END = delegate(Nettention.Proud.HostID remote,Nettention.Proud.RmiContext rmiContext)
		{ 
			return false;
		};
		public delegate bool Set_ENDDelegate(Nettention.Proud.HostID remote,Nettention.Proud.RmiContext rmiContext, System.String team_color);  
		public Set_ENDDelegate Set_END = delegate(Nettention.Proud.HostID remote,Nettention.Proud.RmiContext rmiContext, System.String team_color)
		{ 
			return false;
		};
	public override bool ProcessReceivedMessage(Nettention.Proud.ReceivedMessage pa, Object hostTag) 
	{
        ...
        case Common.JoinGameRoom:
            ...
            break;
        case Common.JoinInGame:
            ProcessReceivedMessage_JoinInGame(__msg, pa, hostTag, remote);
            break;
        ...
        case Common.Room_Disappear:
            ...
            break;
        case Common.Game_Appear:
            ProcessReceivedMessage_Game_Appear(__msg, pa, hostTag, remote);
            break;
        case Common.CountStart:
            ProcessReceivedMessage_CountStart(__msg, pa, hostTag, remote);
            break;
        case Common.GameStart:
            ProcessReceivedMessage_GameStart(__msg, pa, hostTag, remote);
            break;
        case Common.Player_SetReady:
            ProcessReceivedMessage_Player_SetReady(__msg, pa, hostTag, remote);
            break;
        case Common.Player_SetResponse:
            ProcessReceivedMessage_Player_SetResponse(__msg, pa, hostTag, remote);
            break;
        ...
        case Common.Room_Item:
            ...
            break;
        case Common.Player_Kill:
            ProcessReceivedMessage_Player_Kill(__msg, pa, hostTag, remote);
            break;
        case Common.Get_selete:
            ProcessReceivedMessage_Get_selete(__msg, pa, hostTag, remote);
            break;
        case Common.Set_selete:
            ProcessReceivedMessage_Set_selete(__msg, pa, hostTag, remote);
            break;
        case Common.Get_END:
            ProcessReceivedMessage_Get_END(__msg, pa, hostTag, remote);
            break;
        case Common.Set_END:
            ProcessReceivedMessage_Set_END(__msg, pa, hostTag, remote);
            break;
		default:
			 goto __fail;
		}
...
core.PostCheckReadMessage(__msg, RmiName_JoinGameRoom);
    ...
    void ProcessReceivedMessage_JoinInGame(Nettention.Proud.Message __msg, Nettention.Proud.ReceivedMessage pa, Object hostTag, Nettention.Proud.HostID remote)
    {
        Nettention.Proud.RmiContext ctx = new Nettention.Proud.RmiContext();
        ctx.sentFrom=pa.RemoteHostID;
        ctx.relayed=pa.IsRelayed;
        ...
        int character_num; Nettention.Proud.Marshaler.Read(__msg,out character_num);	
int Room_id; Nettention.Proud.Marshaler.Read(__msg,out Room_id);	
core.PostCheckReadMessage(__msg, RmiName_JoinInGame);
        if(enableNotifyCallFromStub==true)
        {
        string parameterString = "";
        parameterString+=character_num.ToString()+",";
parameterString+=Room_id.ToString()+",";
        NotifyCallFromStub(Common.JoinInGame, RmiName_JoinInGame,parameterString);
        }

        if(enableStubProfiling)
        {
        Nettention.Proud.BeforeRmiSummary summary = new Nettention.Proud.BeforeRmiSummary();
        summary.rmiID = Common.JoinInGame;
        summary.rmiName = RmiName_JoinInGame;
        summary.hostID = remote;
        summary.hostTag = hostTag;
        BeforeRmiInvocation(summary);
        }
        ...
        // Call this method.
        bool __ret =JoinInGame (remote,ctx , character_num, Room_id );

        if(__ret==false)
        {
        // Error: RMI function that a user did not create has been called. 
        core.ShowNotImplementedRmiWarning(RmiName_JoinInGame);
        }
...
core.PostCheckReadMessage(__msg, RmiName_Room_Disappear);
    ...
    void ProcessReceivedMessage_Game_Appear(Nettention.Proud.Message __msg, Nettention.Proud.ReceivedMessage pa, Object hostTag, Nettention.Proud.HostID remote)
    {
        Nettention.Proud.RmiContext ctx = new Nettention.Proud.RmiContext();
        ctx.sentFrom=pa.RemoteHostID;
        ctx.relayed=pa.IsRelayed;
        ...
        int value; Nettention.Proud.Marshaler.Read(__msg,out value);	
int team_num; Nettention.Proud.Marshaler.Read(__msg,out team_num);	
...
parameterString+=R_score.ToString()+",";
        ...
        {
        Nettention.Proud.BeforeRmiSummary summary = new Nettention.Proud.BeforeRmiSummary();
        summary.rmiID = Common.Game_Appear;
        summary.rmiName = RmiName_Game_Appear;
        summary.hostID = remote;
        summary.hostTag = hostTag;
        BeforeRmiInvocation(summary);
        }
        ...
        {
        // Error: RMI function that a user did not create has been called. 
        core.ShowNotImplementedRmiWarning(RmiName_Game_Appear);
        }
    ...
    void ProcessReceivedMessage_CountStart(Nettention.Proud.Message __msg, Nettention.Proud.ReceivedMessage pa, Object hostTag, Nettention.Proud.HostID remote)
    {
        Nettention.Proud.RmiContext ctx = new Nettention.Proud.RmiContext();
        ctx.sentFrom=pa.RemoteHostID;
        ctx.relayed=pa.IsRelayed;
        ...
        core.PostCheckReadMessage(__msg, RmiName_CountStart);
        if(enableNotifyCallFromStub==true)
        {
        string parameterString = "";
                NotifyCallFromStub(Common.CountStart, RmiName_CountStart,parameterString);
        }

        if(enableStubProfiling)
        {
        Nettention.Proud.BeforeRmiSummary summary = new Nettention.Proud.BeforeRmiSummary();
        summary.rmiID = Common.CountStart;
        summary.rmiName = RmiName_CountStart;
        summary.hostID = remote;
        summary.hostTag = hostTag;
        BeforeRmiInvocation(summary);
        }
        ...
        // Call this method.
        bool __ret =CountStart (remote,ctx  );

        if(__ret==false)
        {
        // Error: RMI function that a user did not create has been called. 
        core.ShowNotImplementedRmiWarning(RmiName_CountStart);
        }
    ...
    void ProcessReceivedMessage_Player_SetReady(Nettention.Proud.Message __msg, Nettention.Proud.ReceivedMessage pa, Object hostTag, Nettention.Proud.HostID remote)
    {
        Nettention.Proud.RmiContext ctx = new Nettention.Proud.RmiContext();
        ctx.sentFrom=pa.RemoteHostID;
        ctx.relayed=pa.IsRelayed;
        ...
        core.PostCheckReadMessage(__msg, RmiName_Player_SetReady);
        if(enableNotifyCallFromStub==true)
        {
        string parameterString = "";
                NotifyCallFromStub(Common.Player_SetReady, RmiName_Player_SetReady,parameterString);
        }

        if(enableStubProfiling)
        {
        Nettention.Proud.BeforeRmiSummary summary = new Nettention.Proud.BeforeRmiSummary();
        summary.rmiID = Common.Player_SetReady;
        summary.rmiName = RmiName_Player_SetReady;
        summary.hostID = remote;
        summary.hostTag = hostTag;
        BeforeRmiInvocation(summary);
        }
        ...
        // Call this method.
        bool __ret =Player_SetReady (remote,ctx  );

        if(__ret==false)
        {
        // Error: RMI function that a user did not create has been called. 
        core.ShowNotImplementedRmiWarning(RmiName_Player_SetReady);
        }
    ...
    void ProcessReceivedMessage_Player_SetResponse(Nettention.Proud.Message __msg, Nettention.Proud.ReceivedMessage pa, Object hostTag, Nettention.Proud.HostID remote)
    {
        Nettention.Proud.RmiContext ctx = new Nettention.Proud.RmiContext();
        ctx.sentFrom=pa.RemoteHostID;
        ctx.relayed=pa.IsRelayed;
        ...
        int team_num; Nettention.Proud.Marshaler.Read(__msg,out team_num);	
bool value; Nettention.Proud.Marshaler.Read(__msg,out value);	
core.PostCheckReadMessage(__msg, RmiName_Player_SetResponse);
        if(enableNotifyCallFromStub==true)
        {
        string parameterString = "";
        parameterString+=team_num.ToString()+",";
parameterString+=value.ToString()+",";
        NotifyCallFromStub(Common.Player_SetResponse, RmiName_Player_SetResponse,parameterString);
        }

        if(enableStubProfiling)
        {
        Nettention.Proud.BeforeRmiSummary summary = new Nettention.Proud.BeforeRmiSummary();
        summary.rmiID = Common.Player_SetResponse;
        summary.rmiName = RmiName_Player_SetResponse;
        summary.hostID = remote;
        summary.hostTag = hostTag;
        BeforeRmiInvocation(summary);
        }
        ...
        // Call this method.
        bool __ret =Player_SetResponse (remote,ctx , team_num, value );

        if(__ret==false)
        {
        // Error: RMI function that a user did not create has been called. 
        core.ShowNotImplementedRmiWarning(RmiName_Player_SetResponse);
        }
...
parameterString+=iz.ToString()+",";
    ...
    void ProcessReceivedMessage_Player_Kill(Nettention.Proud.Message __msg, Nettention.Proud.ReceivedMessage pa, Object hostTag, Nettention.Proud.HostID remote)
    {
        Nettention.Proud.RmiContext ctx = new Nettention.Proud.RmiContext();
        ctx.sentFrom=pa.RemoteHostID;
        ctx.relayed=pa.IsRelayed;
        ...
        int m_team_num; Nettention.Proud.Marshaler.Read(__msg,out m_team_num);	
core.PostCheckReadMessage(__msg, RmiName_Player_Kill);
        if(enableNotifyCallFromStub==true)
        {
        string parameterString = "";
        parameterString+=m_team_num.ToString()+",";
        NotifyCallFromStub(Common.Player_Kill, RmiName_Player_Kill,parameterString);
        }

        if(enableStubProfiling)
        {
        Nettention.Proud.BeforeRmiSummary summary = new Nettention.Proud.BeforeRmiSummary();
        summary.rmiID = Common.Player_Kill;
        summary.rmiName = RmiName_Player_Kill;
        summary.hostID = remote;
        summary.hostTag = hostTag;
        BeforeRmiInvocation(summary);
        }
        ...
        // Call this method.
        bool __ret =Player_Kill (remote,ctx , m_team_num );

        if(__ret==false)
        {
        // Error: RMI function that a user did not create has been called. 
        core.ShowNotImplementedRmiWarning(RmiName_Player_Kill);
        }
    ...
    void ProcessReceivedMessage_Get_selete(Nettention.Proud.Message __msg, Nettention.Proud.ReceivedMessage pa, Object hostTag, Nettention.Proud.HostID remote)
    {
        Nettention.Proud.RmiContext ctx = new Nettention.Proud.RmiContext();
        ctx.sentFrom=pa.RemoteHostID;
        ctx.relayed=pa.IsRelayed;
        ...
        core.PostCheckReadMessage(__msg, RmiName_Get_selete);
        if(enableNotifyCallFromStub==true)
        {
        string parameterString = "";
                NotifyCallFromStub(Common.Get_selete, RmiName_Get_selete,parameterString);
        }

        if(enableStubProfiling)
        {
        Nettention.Proud.BeforeRmiSummary summary = new Nettention.Proud.BeforeRmiSummary();
        summary.rmiID = Common.Get_selete;
        summary.rmiName = RmiName_Get_selete;
        summary.hostID = remote;
        summary.hostTag = hostTag;
        BeforeRmiInvocation(summary);
        }
        ...
        // Call this method.
        bool __ret =Get_selete (remote,ctx  );

        if(__ret==false)
        {
        // Error: RMI function that a user did not create has been called. 
        core.ShowNotImplementedRmiWarning(RmiName_Get_selete);
        }
    ...
    void ProcessReceivedMessage_Set_selete(Nettention.Proud.Message __msg, Nettention.Proud.ReceivedMessage pa, Object hostTag, Nettention.Proud.HostID remote)
    {
        Nettention.Proud.RmiContext ctx = new Nettention.Proud.RmiContext();
        ctx.sentFrom=pa.RemoteHostID;
        ctx.relayed=pa.IsRelayed;
...
int Min; Nettention.Proud.Marshaler.Read(__msg,out Min);	
int Sec; Nettention.Proud.Marshaler.Read(__msg,out Sec);	
core.PostCheckReadMessage(__msg, RmiName_Set_selete);
        if(enableNotifyCallFromStub==true)
        {
        string parameterString = "";
...
parameterString+=Min.ToString()+",";
parameterString+=Sec.ToString()+",";
        NotifyCallFromStub(Common.Set_selete, RmiName_Set_selete,parameterString);
        }

        if(enableStubProfiling)
        {
        Nettention.Proud.BeforeRmiSummary summary = new Nettention.Proud.BeforeRmiSummary();
        summary.rmiID = Common.Set_selete;
        summary.rmiName = RmiName_Set_selete;
        summary.hostID = remote;
        summary.hostTag = hostTag;
        BeforeRmiInvocation(summary);
        }
        ...
        // Call this method.
        bool __ret =Set_selete (remote,ctx , result, Room_id, Min, Sec );

        if(__ret==false)
        {
        // Error: RMI function that a user did not create has been called. 
        core.ShowNotImplementedRmiWarning(RmiName_Set_selete);
        }
    ...
    void ProcessReceivedMessage_Get_END(Nettention.Proud.Message __msg, Nettention.Proud.ReceivedMessage pa, Object hostTag, Nettention.Proud.HostID remote)
    {
        Nettention.Proud.RmiContext ctx = new Nettention.Proud.RmiContext();
        ctx.sentFrom=pa.RemoteHostID;
        ctx.relayed=pa.IsRelayed;
        ...
        core.PostCheckReadMessage(__msg, RmiName_Get_END);
        if(enableNotifyCallFromStub==true)
        {
        string parameterString = "";
                NotifyCallFromStub(Common.Get_END, RmiName_Get_END,parameterString);
        }

        if(enableStubProfiling)
        {
        Nettention.Proud.BeforeRmiSummary summary = new Nettention.Proud.BeforeRmiSummary();
        summary.rmiID = Common.Get_END;
        summary.rmiName = RmiName_Get_END;
        summary.hostID = remote;
        summary.hostTag = hostTag;
        BeforeRmiInvocation(summary);
        }
        ...
        // Call this method.
        bool __ret =Get_END (remote,ctx  );

        if(__ret==false)
        {
        // Error: RMI function that a user did not create has been called. 
        core.ShowNotImplementedRmiWarning(RmiName_Get_END);
        }
    ...
    void ProcessReceivedMessage_Set_END(Nettention.Proud.Message __msg, Nettention.Proud.ReceivedMessage pa, Object hostTag, Nettention.Proud.HostID remote)
    {
        Nettention.Proud.RmiContext ctx = new Nettention.Proud.RmiContext();
        ctx.sentFrom=pa.RemoteHostID;
        ctx.relayed=pa.IsRelayed;
        ...
        System.String team_color; Nettention.Proud.Marshaler.Read(__msg,out team_color);	
core.PostCheckReadMessage(__msg, RmiName_Set_END);
        if(enableNotifyCallFromStub==true)
        {
        string parameterString = "";
        parameterString+=team_color.ToString()+",";
        NotifyCallFromStub(Common.Set_END, RmiName_Set_END,parameterString);
        }

        if(enableStubProfiling)
        {
        Nettention.Proud.BeforeRmiSummary summary = new Nettention.Proud.BeforeRmiSummary();
        summary.rmiID = Common.Set_END;
        summary.rmiName = RmiName_Set_END;
        summary.hostID = remote;
        summary.hostTag = hostTag;
        BeforeRmiInvocation(summary);
        }
        ...
        // Call this method.
        bool __ret =Set_END (remote,ctx , team_color );

        if(__ret==false)
        {
        // Error: RMI function that a user did not create has been called. 
        core.ShowNotImplementedRmiWarning(RmiName_Set_END);
        }
